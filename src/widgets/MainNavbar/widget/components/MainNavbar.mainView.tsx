...
export default function MainNavbarMainView({ links, user }: MainNavbarMainViewProps) {
  ...
  return (
      <Navbar>
        ...
        <Navbar.End className="navbar-end">
          ...
          {user && (<>
            <Avatar shape="circle" size="xs" color="primary" borderColor="secondary" letters={user.fullName[0]} />
          </>)}
        </Navbar.End>
      </Navbar>
  );
