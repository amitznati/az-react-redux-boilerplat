...
import {chatPropType as TChatPropType, messagePropType as TMessagePropType} from './Chat';
import {InputFieldProps as TInputFieldProps} from './InputField';

export {default as InputField} from './InputField';
export type inputFieldProps = TInputFieldProps;
export {default as Chat} from './Chat';
export type chatPropsType = TChatPropType;
export type messagePropsType = TMessagePropType;
